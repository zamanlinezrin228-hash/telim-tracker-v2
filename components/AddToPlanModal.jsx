      ...
      <div className="card modal-card" style={{ width: 460 }}>
        ...
        {budgetStatus === 'Büdcələnməmiş' ? (
          <div style={{ background: '#fff7ed', border: '1px solid #fed7aa', color: '#9a3412', fontSize: 12.5, padding: '10px 12px', borderRadius: 8, marginBottom: 14 }}>
            Bu təlim illik büdcə planlaşdırma dövründən (Oktyabr–Yanvar) kənarda təsdiqlənir, ona görə <b>&quot;Büdcələnməmiş&quot;</b> kateqoriyasında qeyd olunacaq. Əvvəlcədən planlaşdırılmış büdcəyə daxil olmadığı üçün əlavə təsdiq tələb oluna bilər.
          </div>
        ) : (
